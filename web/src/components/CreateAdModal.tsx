      ...
      <Dialog.Content className="fixed bg-[#2a2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-black/25 ">
        ...
        <form className="mt-8 flex flex-col gap-4" onSubmit={handleCreateAd}>
          <div className="flex flex-col gap-2">
            ...
            <div className="relative flex items-center">
              <select
                ...
                name="game"
                defaultValue=""
                className="bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500 appearance-none w-full"
              >
              ...
              <CaretDown className="absolute right-4 pointer-events-none" />
            </div>
          </div>
          ...
          <div className="flex gap-6">
            <div className="flex flex-col gap-2">
              <label htmlFor="weekDays">Qundo costume jogar?</label>
